...
CREATE TABLE IF NOT EXISTS site_parameter_definition (
    ...
    options TEXT COMMENT 'JSON 배열 문자열 (select 타입인 경우 옵션 목록)',
...
CREATE TABLE IF NOT EXISTS crawl_site_config (
    ...
    param_values TEXT COMMENT 'JSON 객체 문자열 (파라미터 값)',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS crawl_data (
    ...
    category VARCHAR(100) COMMENT '카테고리명',
    ...
    tags TEXT COMMENT '태그 목록 (JSON 배열)',
...
-- ============================================================
-- 초기 데이터: site_parameter_definition (점핏)
-- ============================================================
INSERT INTO site_parameter_definition (site_definition_id, param_key, param_name, param_type, is_required, options, display_order) VALUES
(4, 'keyword', '검색어', 'text', TRUE, NULL, 1),
(4, 'career', '경력', 'select', TRUE, '["신입","1~3년","3~5년","5~10년","10년↑"]', 2),
(4, 'education', '학력', 'select', TRUE, '["고졸","대졸","석사","박사"]', 3),
(4, 'job_type', '직무', 'select', TRUE, '["서버/백엔드","프론트엔드","풀스택","모바일","인프라","데이터"]', 4),
(4, 'location', '지역', 'select', TRUE, '["서울","경기","인천","부산","대구","대전","광주","기타"]', 5);

-- ============================================================
-- 초기 데이터: site_parameter_definition (인크루트)
-- ============================================================
INSERT INTO site_parameter_definition (site_definition_id, param_key, param_name, param_type, is_required, options, display_order) VALUES
(5, 'keyword', '검색어', 'text', TRUE, NULL, 1),
(5, 'career', '경력', 'select', TRUE, '["신입","1~3년","3~5년","5~10년","10년↑"]', 2),
(5, 'education', '학력', 'select', TRUE, '["고졸","대졸","석사","박사"]', 3),
(5, 'job_type', '직무', 'select', TRUE, '["개발","기획","디자인","마케팅","영업"]', 4),
(5, 'location', '지역', 'select', TRUE, '["서울","경기","인천","부산","대구","대전","광주","기타"]', 5);

-- ============================================================
-- 초기 데이터: site_parameter_definition (리멤버)
-- ============================================================
INSERT INTO site_parameter_definition (site_definition_id, param_key, param_name, param_type, is_required, options, display_order) VALUES
(6, 'keyword', '검색어', 'text', TRUE, NULL, 1),
(6, 'career', '경력', 'select', TRUE, '["신입","1~3년","3~5년","5~10년","10년↑"]', 2),
(6, 'education', '학력', 'select', FALSE, '["고졸","대졸","석사","박사"]', 3),
(6, 'job_type', '직무', 'select', TRUE, '["개발","기획","디자인","마케팅","영업"]', 4),
(6, 'location', '지역', 'select', TRUE, '["서울","경기","인천","부산","대구","대전","광주","기타"]', 5);
