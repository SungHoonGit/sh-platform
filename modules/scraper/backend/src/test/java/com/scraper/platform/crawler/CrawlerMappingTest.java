...
class CrawlerMappingTest {
    ...
    class JobkoreaMapping {
        ...
        class MapCareerType {
            ...
            @Test
            @DisplayName("신입을 new로 매핑한다")
            void 신입_매핑() {
                assertEquals("new", crawler.mapCareerType("신입"));
            }

            @Test
            @DisplayName("경력을 career로 매핑한다")
            void 경력_매핑() {
                assertEquals("career", crawler.mapCareerType("경력"));
            }

            @Test
            @DisplayName("1~3년을 career로 매핑한다")
            void 경력_1_3년_매핑() {
                assertEquals("career", crawler.mapCareerType("1~3년"));
            }

            @Test
            @DisplayName("3~5년을 career로 매핑한다")
            void 경력_3_5년_매핑() {
                assertEquals("career", crawler.mapCareerType("3~5년"));
            }

            @Test
            @DisplayName("5~10년을 career로 매핑한다")
            void 경력_5_10년_매핑() {
                assertEquals("career", crawler.mapCareerType("5~10년"));
            }

            @Test
            @DisplayName("10년이상을 career로 매핑한다")
            void 경력_10년이상_매핑() {
                assertEquals("career", crawler.mapCareerType("10년이상"));
            }
        ...
        class MapLocationCode {
            ...
            @Test
            @DisplayName("경기를 I100으로 매핑한다")
            void 경기_매핑() {
                assertEquals("I100", crawler.mapLocationCode("경기"));
            }

            @Test
            @DisplayName("인천을 I200으로 매핑한다")
            void 인천_매핑() {
                assertEquals("I200", crawler.mapLocationCode("인천"));
            }

            @Test
            @DisplayName("부산을 I300으로 매핑한다")
            void 부산_매핑() {
                assertEquals("I300", crawler.mapLocationCode("부산"));
            }

            @Test
            @DisplayName("제주를 I900으로 매핑한다")
            void 제주_매핑() {
                assertEquals("I900", crawler.mapLocationCode("제주"));
            }
