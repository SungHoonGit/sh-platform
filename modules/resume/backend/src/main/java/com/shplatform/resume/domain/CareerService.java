...
public interface CareerService {
     ...
     */
    List<CareerResponse> getCareers(Long userId, Long documentId);
     ...
     * @return 생성된 경력
     */
    CareerResponse createCareer(Long userId, Long documentId, CareerRequest request);
     ...
     */
    CareerResponse updateCareer(Long userId, Long careerId, Long documentId, CareerRequest request);
     ...
     * @throws BusinessException NOT_FOUND 경력이 없을 때, FORBIDDEN 다른 사용자의 경력일 때
     */
    void deleteCareer(Long userId, Long careerId, Long documentId);
     ...
     */
    void reorderCareers(Long userId, Long documentId, List<Long> orderedIds);
}
