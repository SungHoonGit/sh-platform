...
import com.shplatform.auth.domain.LogoutService;
...
public class AuthController {
    ...
    @PostMapping("/logout")
    @Operation(summary = "로그아웃", description = "refreshToken을 무효화하고, accessToken을 블랙리스트에 추가한다.")
    public ResponseEntity<ApiResponse<Void>> logout(
        ...
        if (authorization != null && authorization.startsWith("Bearer ")) {
            logoutService.logoutByAccessToken(authorization.substring(7));
        }
    ...
    public ResponseEntity<ApiResponse<UserResponse>> getMyProfile(
        ...
        var user = authService.getUser(currentUserResolver.resolveUserId(principal));
    ...
    public ResponseEntity<ApiResponse<UserResponse>> updateMyProfile(
        ...
        var user = authService.updateProfile(currentUserResolver.resolveUserId(principal), request);
        var response = toUserResponse(user);
    ...
    public ResponseEntity<ApiResponse<Void>> changePassword(
        ...
        authService.changePassword(currentUserResolver.resolveUserId(principal), request);
    ...
    public ResponseEntity<ApiResponse<Void>> setPassword(
        ...
        authService.setPassword(currentUserResolver.resolveUserId(principal), request);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteAccount(
        ...
        authService.deleteAccount(currentUserResolver.resolveUserId(principal), password);
