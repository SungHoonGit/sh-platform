...
> **⚠️ 진행 중인 작업**: 계정 설정 비밀번호 변경 UX 개선 완료 — `WRONG_CURRENT_PASSWORD`(400) 신설 + 프론트 규칙/로딩/명확한 오류 문구 + 현재 비밀번호 필드 자동 포커스. 커밋 `e7b313e` 푸시 완료.
...
> 다음: 이력서 PDF/공개뷰 간격·leading 축소 완료, 공유 링크·이력서 PDF 실사용자 최종 확인.
